...
class ECO(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.mainshop = [{"name": "Cookie", "price": 100, "description": "There Is No Description For A Cookie Smh"},
                         {"name": "Fish", "price": 200,
                             "description": "Don't You Love The Smell"},
                         {"name": "Koolaid", "price": 300,
                             "description": "Cool Now You Got A Koolaid"},
                         {"name": "Laptop", "price": 1000,
                          "description": "Good Job Now You Can Play Tetris"},
    ...
    async def inventory(self, ctx):
        await self.open_account(ctx.author)
        user = ctx.author
        users = await self.get_item_data()
    ...
    async def leaderboard(self, ctx, x=5):
        ...
        em = discord.Embed(
            ...
            description="Richest Player Check",
