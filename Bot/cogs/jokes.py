...
class jokes(commands.Cog):
    ...
    async def joke(self, ctx, arg=None):
        if arg is None:
            r  = requests.get("https://sv443.net/jokeapi/v2/joke/Miscellaneous?blacklistFlags=nsfw,religious,political,racist,sexist&type=twopart")
            joke = r.json()
            embed = discord.Embed(
            ...
            try:
                ...
                r = requests.get(f"https://sv443.net/jokeapi/v2/joke/{arg}?blacklistFlags=nsfw,religious,political,racist,sexist&type=twopart")
